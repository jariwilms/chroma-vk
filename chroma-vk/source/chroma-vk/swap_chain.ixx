...
//        return vx::enumerate_result_of<::vkGetPhysicalDeviceSurfaceFormats2KHR, vx::surface_format>(physical_device, physical_device_surface_info);
//    }
//    template<std::convertible_to<vx::physical_device_t> T, std::convertible_to<vx::surface_t> U>
...
//    {
//        return vx::enumerate_result_of<::vkGetSwapchainImagesKHR, T>(logical_device, swap_chain);
//    }
//
//    template<std::convertible_to<vx::logical_device_t> T>
